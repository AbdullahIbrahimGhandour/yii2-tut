...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrap">
        <div class="header">
            <div class="container">
                <div class="logo">
                    <a href="/site"><span>Re</span>sale</a>
                </div>
                <div class="header-right">
                    <?php
                    if(Yii::$app->user->isGuest) {
                        ?>
                        <a class="account" href="/site/login">Login</a>
                        <?php
                    } else {
                        ?>
                        Hello <a href="/profile"><?= Yii::$app->user->identity->username ?></a>
                        <a class="account" href="/site/signout">Logout</a>
                        <?php
                    }
                    ?>
